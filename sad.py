...
label2emotion = {0:"others", 1: "sad"}
emotion2label = {"others":0, "happy":0, "sad":1, "angry":0}
...
def main():
    ...
    checkpoint = ModelCheckpoint('sad.h5', monitor='val_acc', verbose=1, save_best_only=True,
mode='max')
    callbacks_list = [checkpoint]
    # Fit the model
    model.fit(data, labels, epochs=NUM_EPOCHS, batch_size=BATCH_SIZE, callbacks=callbacks_list)
    ...
    wrong=[]
    with io.open('sad.txt', "w", encoding="utf8") as fout:
