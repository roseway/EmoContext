...
#testDataPath = "data/dev.txt"
## Output file that will be generated. This file can be directly submitted.
#solutionPath = "output.txt"
## Path to directory where GloVe file is saved.
#gloveDir = "data/glove.6B.300d.txt"

#NUM_FOLDS = 5                  # Value of K in K-fold Cross Validation
#NUM_CLASSES = 4                 # Number of classes - Happy, Sad, Angry, Others
#MAX_NB_WORDS = 40                # To set the upper limit on the number of tokens extracted using keras.preprocessing.text.Tokenizer 
#MAX_SEQUENCE_LENGTH = 40         # All sentences having lesser number of words than this will be padded
#EMBEDDING_DIM = 300               # The dimension of the word embeddings
#BATCH_SIZE = 4000                  # The batch size to be chosen for training the model.
#LSTM_DIM = 200                    # The dimension of the representations learnt by the LSTM model
...
#NUM_EPOCHS = 5                  # Number of epochs to train a model for
...
#    checkpoint = ModelCheckpoint('baseline.h5', monitor='val_acc', verbose=1, save_best_only=True,
#mode='max')
...
#    wrong=[]
#    with io.open('baseline.txt', "w", encoding="utf8") as fout:
